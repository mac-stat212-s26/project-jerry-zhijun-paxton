...
subtitle: "Governance, Inequality, and the Micro-Enterprise Paradox in Brazil"
author:
  - name: "Zhijun He"
    affiliation: "Member 1 — Project Lead · Part I author"
  - name: "Jerry Miao"
    affiliation: "Member 2 — Part II author"
  - name: "Paxton Boyd"
    affiliation: "Member 3 — Part III author"
date: "2026-02-25"
abstract: |
  A three-part exploratory data analysis of Brazil's CNPJ formal-sector firm
  registry, examining the limits of revenue-based firm classification when
  capital ownership and governance structure carry information that revenue
  alone cannot. Part I establishes that capital concentration is a universal
  power-law shared across every firm-size tier (Gini > 0.98 everywhere). Part
  II shows that governance archetype shapes the capital distribution
  tier-dependently — Beneficial Owners carry the heavy tail at Micro, Managing
  Partners carry it at Medium/Large. Part III ranks legal-form × governance
  cells within micros and identifies the partnership-with-passive-equity
  combination, not EIRELI, as the dominant capital-rich-micro escape route.
  The combined finding is that revenue alone is a porous targeting instrument
...
{{< video https://youtu.be/ztqXGVTrCgs aspect-ratio="16x9" >}}


## Presentation Materials

- [View final presentation slides](assets/slides/capital-without-category-final-slides.pdf)
